...
%	\begin{small}
%	$\bullet$ ~transitions sensibilisées en parallèle, \\
...
%	\end{small}
%\column{.35\textwidth}
%	\centerline{\includegraphics[width=3.5cm]{rdp_s_entre}}
%\end{columns}
%\pause
%\begin{columns}
%\column{.35\textwidth}
%	\centerline{\includegraphics[width=3.5cm]{rdp_s_forte}}
%\column{.05\textwidth}\column{.65\textwidth}
